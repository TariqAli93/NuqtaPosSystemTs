import { BarcodeTemplate, BarcodePrintJob } from '../entities/Barcode';
...
export interface IBarcodeRepository {
  ...
  updateTemplate(id: number, template: Partial<BarcodeTemplate>): Promise<BarcodeTemplate>;
  ...
  updatePrintJobStatus(id: number, status: string, error?: string): Promise<void>;
